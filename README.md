...
- **ペルソナ機能**: 各AI参加者に役割や性格を設定可能:
  - 哲学者、科学者、弁護士などの役割を与えられます
  - ペルソナは自動的に最初のメッセージに追加されます
  - より深みのある議論を実現
...
2. **設定を構成**:
   ...
   - **AI参加者1のペルソナ**: 役割や性格を設定（例：「あなたは哲学者です」）
   - **AI参加者2**: 2番目の参加者としてChatGPTまたはGeminiを選択
   - **AI参加者2のペルソナ**: 役割や性格を設定（例：「あなたは科学者です」）
...
ペルソナ機能を使用すると、各AI参加者に特定の役割や視点を与えることができます。

### ペルソナの例

**哲学者 vs 科学者:**
- 参加者1のペルソナ: `あなたは哲学者です。深い洞察と論理的な議論を展開し、抽象的な概念について考察してください。`
- 参加者2のペルソナ: `あなたは科学者です。実証的な証拠と科学的な方法論に基づいて議論し、具体的なデータを重視してください。`

**楽観主義者 vs 悲観主義者:**
- 参加者1のペルソナ: `あなたは楽観主義者です。物事の明るい面を見て、可能性とポジティブな結果に焦点を当ててください。`
- 参加者2のペルソナ: `あなたは悲観主義者です。リスクと潜在的な問題点を指摘し、慎重な視点を提供してください。`

**歴史学者 vs 未来学者:**
- 参加者1のペルソナ: `あなたは歴史学者です。過去の事例や歴史的な教訓に基づいて議論してください。`
- 参加者2のペルソナ: `あなたは未来学者です。トレンドと将来の可能性に焦点を当て、革新的な視点を提供してください。`
